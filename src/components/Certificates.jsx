...
function Certificates () {
    ...
    return (
        <div className="section bg-[#0F172A] text-[#EBEBEB] px-4 md:px-24 flex flex-col justify-start md:justify-center pt-20 md:pt-0 h-screen">
            ...
            <div className="flex items-center justify-center gap-2 md:gap-6">
                ...
                <div className="flex gap-9 justify-center">
                    {certificates.slice(currentIndex, currentIndex + visibleCount).map((certificate, i) => (
                        <div key={i} className="shrink-0 w-72 h-96 bg-[#1E293B] border border-[#334155] rounded-xl shadow-md flex flex-col overflow-hidden">
                            <CertCard
